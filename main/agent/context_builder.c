...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "Use for continuous control loops like 'when motion detected, turn on light' or 'if temperature > 30, run fan script'. "
        ...
        "Use for sensor-driven control loops: \"when motion detected, turn on light\", \"if GPIO 4 is HIGH, set GPIO 5 HIGH\". "
        ...
        "Decision rule: If the user says \"automatically\", \"when X happens\", \"monitor and react\", \"sensor-triggered\" → use rule_add.\n\n"
        "## Memory\n"
